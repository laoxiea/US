...
function() {
    ...
    function I(t) {
        ...
        (Array.isArray(t) ? t: [t]).map(function(t) {
            return "function" == typeof t && (t = t()),
            p(t) || N(t) ? t: "string" == typeof t && /\S/.test(t) ? de.createTextNode(t) : void 0
        }).filter(function(t) {
            return t
        })
    }
    ...
    function q(t, e, n) {
        if (V(t)) {
            ...
            if (r.handlers) {
                ...
                } else for (var a in r.handlers) Object.prototype.hasOwnProperty.call(r.handlers || {},
                a) && i(t, a)
            }
        }
    }
    ...
    function J(t, e) {
        ...
        t.state = r({},
        t.state, e),
        "function" == typeof t.handleStateChanged && vn(t) && t.on("statechanged", t.handleStateChanged),
        t
    }
    function Q(t) {
    ...
    function ht(t, e, n) {
        ...
        "[object Array]" === lr.call(t) ? pt(t, e, n) : "string" == typeof t ? dt(t, e, n) : ft(t, e, n)
    }
    function pt(t, e, n) {
        for (var r = 0,
        i = t.length; r < i; r++) cr.call(t, r) && e.call(n, t[r], r, t)
    }
    function dt(t, e, n) {
        for (var r = 0,
    ...
    function _t(t) {
        ...
        function i() {
            if (!c) {
                ...
                a.getAllResponseHeaders && (r.headers = hr(a.getAllResponseHeaders()))) : i = new Error("Internal XMLHttpRequest Error"),
                s(i, r, r.body)
            }
        }
    ...
    function Nt(t, e, n) {
        ...
        r || (s.direction = At(this.cueDiv), s.writingMode = "" === e.vertical ? "horizontal-tb": "lr" === e.vertical ? "vertical-lr": "vertical-rl".stylesunicodeBidi = "plaintext"),
        this.applyStyles(s),
    ...
    function Ft(t, e, n) {
        ...
        m = 50,
        _ = "middle";
        if (Object.defineProperty(r, "id", Bt({},
        o, {
            get: function() {
                return s
            },
        ...
        })), Object.defineProperty(r, "pauseOnExit", Bt({},
        o, {
            get: function() {
                return a
            },
        ...
        })), Object.defineProperty(r, "startTime", Bt({},
        o, {
            get: function() {
                return l
            },
        ...
        })), Object.defineProperty(r, "endTime", Bt({},
        o, {
            get: function() {
                return c
            },
        ...
        })), Object.defineProperty(r, "text", Bt({},
        o, {
            get: function() {
                return u
            },
        ...
        })), Object.defineProperty(r, "region", Bt({},
        o, {
            get: function() {
                return h
            },
        ...
        })), Object.defineProperty(r, "vertical", Bt({},
        o, {
            get: function() {
                return p
            },
        ...
        })), Object.defineProperty(r, "snapToLines", Bt({},
        o, {
            get: function() {
                return d
            },
        ...
        })), Object.defineProperty(r, "line", Bt({},
        o, {
            get: function() {
                return f
            },
        ...
        })), Object.defineProperty(r, "lineAlign", Bt({},
        o, {
            get: function() {
                return v
            },
        ...
        })), Object.defineProperty(r, "position", Bt({},
        o, {
            get: function() {
                return y
            },
        ...
        })), Object.defineProperty(r, "positionAlign", Bt({},
        o, {
            get: function() {
                return g
            },
        ...
        })), Object.defineProperty(r, "size", Bt({},
        o, {
            get: function() {
                return m
            },
        ...
        })), Object.defineProperty(r, "align", Bt({},
        o, {
            get: function() {
                return _
            },
    ...
    function $t() {
        ...
        if ("string" == typeof a) $t(t, Hr[a], n, i, o, s);
            ...
            function(e, r) {
                ...
                o.push(c),
                $t(r, t.type === r.type ? l: Hr[r.type], n, i, o, s)
            })
    ...
    function re(t, e, n) {
        ...
        if ("string" == typeof t) {
            var o = re.getPlayers();
            if (0 === t.indexOf("#") && (t = t.slice(1)), o[t]) return e && Ye.warn('Player "' + t + '" is already initialised. Options will not be applied.'),
            n && o[t].ready(n),
            o[t];
            r = Je("#" + t)
        } else r = t;
        ...
        p(r) && !de.body.contains(r) && Ye.warn("The element supplied is not included in the DOM"),
        e = e || {},
    ...
    Oe = function() {
        ...
        e = t && parseFloat(t[1]);
        return ! e && /Trident\/7.0/i.test(fe) && /rv:11.0/.test(fe) && (e = 11),
        e
    } (),
    ...
    Re = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
    function(t) {
        return typeof t
    }: function(t) {
    ...
    cn = function() {
        if (h()) {
            ...
            o = t.length; i < o; i++) r.push(t[i]);
            if (e && e.length > 0) for (var s = 0,
            a = e.length; s < a; s++) r.push(e[s]);
            if (n && n.length > 0) for (var l = 0,
            c = n.length; l < c; l++) r.push(n[l]);
            if (r && r.length > 0) for (var u = 0,
            p = r.length; u < p; u++) {
                var d = r[u];
                if (!d || !d.getAttribute) {
                    G(1);
    ...
    h() && "complete" === de.readyState ? an = !0 : Y(le, "load",
    function() {
        an = !0
    });
    var un = function(t) {
    ...
    Cn = {
        ...
        off: function(t, e, n) {
            if (!t || yn(t)) q(this.eventBusEl_, t, e);
                ...
                n = pn(this, n),
                this.off("dispose", n),
                r.nodeName ? (q(r, i, n), q(r, "dispose", n)) : vn(r) && (r.off(i, n), r.off("dispose", n))
            }
        },
    ...
    En = function() {
        function t(e, n, r) {
            if (Be(this, t), !e && this.play ? this.player_ = e = this: this.player_ = e, this.options_ = tt({},
            this.options_), n = this.options_ = tt(this.options_, n), this.id_ = n.id || n.el && n.el.id, !this.id_) {
        ...
        return t.prototype.dispose = function() {
            ...
            this.el_ && (this.el_.parentNode && this.el_.parentNode.removeChild(this.el_), H(this.el_), this.el_ = null),
            this.player_ = null
        },
        ...
        t.prototype.options = function(t) {
            return Ye.warn("this.options() has been deprecated and will be moved to the constructor in 6.0"),
    ...
    En.prototype.supportsRaf_ = "function" == typeof le.requestAnimationFrame && "function" == typeof le.cancelAnimationFrame,
    En.registerComponent("Component", En);
    for (var wn = {},
    Sn = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenEnabled", "fullscreenchange", "fullscreenerror"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror"], ["webkitRequestFullScreen", "webkitCancelFullScreen", "webkitCurrentFullScreenElement", "webkitCancelFullScreen", "webkitfullscreenchange", "webkitfullscreenerror"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError"]], xn = Sn[0], jn = void 0, An = 0; An < Sn.length; An++) if (Sn[An][1] in de) {
        jn = Sn[An];
        break
    }
    ...
    st.errorTypes = ["MEDIA_ERR_CUSTOM", "MEDIA_ERR_ABORTED", "MEDIA_ERR_NETWORK", "MEDIA_ERR_DECODE", "MEDIA_ERR_SRC_NOT_SUPPORTED", "MEDIA_ERR_ENCRYPTED"],
    st.defaultMessages = {
    ...
    for (var On = 0; On < st.errorTypes.length; On++) st[st.errorTypes[On]] = On,
    st.prototype[st.errorTypes[On]] = On;
    var Nn = at,
    Mn = function(t) {
    ...
    Bn = function(t) {
        ...
        e.prototype.open = function() {
            if (!this.opened_) {
                ...
                this.closeable() && this.on(this.el_.ownerDocument, "keydown", pn(this, this.handleKeyPress)),
        ...
        e.prototype.close = function() {
            if (this.opened_) {
                ...
                this.closeable() && this.off(this.el_.ownerDocument, "keydown", pn(this, this.handleKeyPress)),
        ...
        e.prototype.conditionalFocus_ = function() {
            ...
            e = this.player_.el_;
            this.previouslyActiveEl_ = null,
            (e.contains(t) || e === t) && (this.previouslyActiveEl_ = t, this.focus(), this.on(de, "keydown", this.handleKeyDown))
        },
    ...
    Wn = function(t) {
        function e() {
            ...
            return o = n = Ve(this, t.call(this, i, o)),
            o.changing_ = !1,
            r = o,
            Ve(n, r)
        }
    ...
    Xn = function(t) {
        ...
        e.prototype.addTrack = function(e) {
            t.prototype.addTrack.call(this, e),
            e.addEventListener("modechange", pn(this,
            function() {
                this.trigger("change")
            })),
            -1 === ["metadata", "chapters"].indexOf(e.kind) && e.addEventListener("modechange", pn(this,
            function() {
    ...
    mt.XDomainRequest = "withCredentials" in new mt.XMLHttpRequest ? mt.XMLHttpRequest: le.XDomainRequest,
    function(t, e) {
    ...
    var vr = function(t, e) {
        ...
        n.parse(t),
        r.length > 0 && (le.console && le.console.groupCollapsed && le.console.groupCollapsed("Text Track parsing errors for " + e.src), r.forEach(function(t) {
            return Ye.error(t)
    ...
    Cr = function(t) {
        ...
        default, Object.defineProperty(o, "readyState", {
            ...
            }), i = br, a.addEventListener("loadeddata",
            function() {
                i = Tr,
                o.trigger({
                    type: "load",
    ...
    Object.keys(kr).forEach(function(t) {
        kr[t].getterName = t + "Tracks",
        kr[t].privateName = t + "Tracks_"
    });
    var Er = {
        remoteText: {
            ListClass: Xn,
    ...
    Vr = function(t) {
        ...
        e.prototype.trackProgress = function(t) {
            this.stopTrackingProgress(),
            this.progressInterval = this.setInterval(pn(this,
            function() {
        ...
        e.prototype.error = function(t) {
            return void 0 !== t && (this.error_ = new st(t), this.trigger("error")),
            this.error_
        },
        ...
        e.prototype.addRemoteTextTrack = function() {
            ...
            return ! 0 !== n && !1 !== n && (Ye.warn('Calling addRemoteTextTrack without explicitly setting the "manualCleanup" parameter to `true` is deprecated and default to `false` in future version of video.js'), n = !0),
        ...
        e.getTech = function(t) {
            if (t) return t = Q(t),
            e.techs_ && e.techs_[t] ? e.techs_[t] : le && le.videojs && le.videojs[t] ? (Ye.warn("The " + t + " tech was added to the videojs object when it should be registered using videojs.registerTech(name, tech)"), le.videojs[t]) : void 0
        },
        e
    } (En);
    wr.names.forEach(function(t) {
    ...
    Vr.withSourceHandlers = function(t) {
        ...
        t.prototype.setSource = function(e) {
            ...
            n || (t.nativeSourceHandler ? n = t.nativeSourceHandler: Ye.error("No source hander found for the current source.")),
    ...
    var qr = function(t) {
        ...
        e.prototype.createEl = function() {
            ...
            n),
            "button" === e && Ye.error("Creating a ClickableComponent with an HTML element of " + e + " is not supported; use a Button instead."),
            i = r({
                role: "button",
                "aria-live": "polite"
            },
    ...
    var Kr = function(t) {
        function e(n, r) {
            ...
            var i = Ve(this, t.call(this, n, r));
            return i.update(),
            n.on("posterchange", pn(i, i.update)),
            i
        }
        return Fe(e, t),
        e.prototype.dispose = function() {
        ...
        e.prototype.createEl = function() {
            ...
            return De || (this.fallbackImg_ = v("img"), t.appendChild(this.fallbackImg_)),
            t
        },
    ...
    Gr = function(t) {
        function e(n, r, i) {
            ...
            return n.on("loadstart", pn(o, o.toggleDisplay)),
    ...
    var $r = function(t) {
        function e() {
            return Be(this, e),
            Ve(this, t.apply(this, arguments))
        }
        return Fe(e, t),
        e.prototype.createEl = function() {
            return t.prototype.createEl.call(this, "div", {
    ...
    var Jr = function(t) {
        ...
        e.prototype.addChild = function(t) {
            ...
            return Ye.warn("Adding an actionable (user controllable) child to a Button (" + n + ") is not supported; use a ClickableComponent instead."),
    ...
    ti.prototype.controlText_ = "Play",
    En.registerComponent("PlayToggle", ti);
    var ei = function(t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
            return i.throttledUpdateContent = dn(pn(i, i.updateContent), 25),
    ...
    En.registerComponent("TimeDisplay", ei);
    var ni = function(t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
    ...
    Oe && !(Oe > 8) || be || Ce || ui.prototype.options_.children.push("timeTooltip"),
    En.registerComponent("PlayProgressBar", ui);
    var hi = function(t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
            return i.update = dn(pn(i, i.update), 25),
            i
        }
        return Fe(e, t),
        e.prototype.createEl = function() {
    ...
    di = function(t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
            return i.update = dn(pn(i, i.update), pi),
        ...
        e.prototype.update_ = function(t, e) {
            ...
            this.el_.setAttribute("aria-valuetext", this.localize("progress bar timing: currentTime={1} duration={2}", [Zt(t, n), Zt(n, n)], "{1} of {2}")),
    ...
    Oe && !(Oe > 8) || be || Ce || di.prototype.options_.children.splice(1, 0, "mouseTimeDisplay"),
    ...
    var fi = function(t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
            return i.handleMouseMove = dn(pn(i, i.handleMouseMove), 25),
    ...
    bi.prototype.controlText_ = "Mute",
    En.registerComponent("MuteToggle", bi);
    var Ti = function(t) {
        function e(n) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            Be(this, e),
    ...
    var ki = function(t) {
        ...
        e.prototype.buildWrapperCSSClass = function() {
            ...
            "vjs-menu-button " + e + " " + Jr.prototype.buildCSSClass() + " " + t.prototype.buildCSSClass.call(this)
        },
        e.prototype.buildCSSClass = function() {
            var e = "vjs-menu-button";
            return ! 0 === this.options_.inline ? e += "-inline": e += "-popup",
        ...
        e.prototype.handleClick = function(t) {
            this.one(this.menu.contentEl(), "mouseleave", pn(this,
            function(t) {
                this.unpressButton(),
                this.el_.blur()
            })),
    ...
    var Vi = function(t) {
        ...
        e.prototype.createMenu = function() {
            ...
            if (e) for (var n = e.length - 1; n >= 0; n--) t.addChild(new Fi(this.player(), {
                rate: e[n] + "x"
            }));
            return t
        },
    ...
    var ro = function(t) {
        function r(n, i) {
            ...
            return o.updateDisplay = pn(o, o.updateDisplay),
            o.fill(),
    ...
    oo = function(t) {
        function e(n, r) {
            ...
            (Ie || me || we) && !0 === n.nativeControlsForTouch && i.setControls(!0),
        ...
        e.prototype.createEl = function() {
            ...
            if (!t || !this.options_.playerElIngest && !this.movingMediaElementInDOM) {
                if (t) {
                    ...
                    o = tt({},
                    i);
                    Ie && !0 === this.options_.nativeControlsForTouch || delete o.controls,
                    C(t, r(o, {
        ...
        e.prototype.getVideoPlaybackQuality = function() {
            ...
            le.performance && "function" == typeof le.performance.now ? t.creationTime = le.performance.now() : le.performance && le.performance.timing && "number" == typeof le.performance.timing.navigationStart && (t.creationTime = le.Date.now() - le.performance.timing.navigationStart),
            t
        },
        e
    } (Vr);
    ...
    oo.canControlVolume = function() {
        try {
            ...
            return oo.TEST_VID.volume = t / 2 + .1,
            t !== oo.TEST_VID.volume
        } catch(t) {
            return ! 1
        }
    },
    oo.canControlPlaybackRate = function() {
        ...
        try {
            ...
            return oo.TEST_VID.playbackRate = t / 2 + .1,
    ...
    oo.Events = ["loadstart", "suspend", "abort", "error", "emptied", "stalled", "loadedmetadata", "loadeddata", "canplay", "canplaythrough", "playing", "waiting", "seeking", "seeked", "ended", "durationchange", "timeupdate", "progress", "play", "pause", "ratechange", "resize", "volumechange"],
    ...
    oo.unpatchCanPlayType = function() {
        ...
        return oo.TEST_VID.constructor.prototype.canPlayType = ao,
        t
    },
    oo.patchCanPlayType(),
    ...
    po = function(t) {
        ...
        e.prototype.loadTech_ = function(t, e) {
            ...
            "Html5" !== i && this.tag && (Vr.getTech("Html5").disposeMediaElement(this.tag), this.tag.player = null, this.tag = null),
            this.techName_ = i,
            this.isReady_ = !1;
            var s = {
                source: e,
        ...
        e.prototype.handleTechFirstPlay_ = function() {
            this.options_.starttime && (Ye.warn("Passing the `starttime` option to the player will be deprecated in 6.0"), this.currentTime(this.options_.starttime)),
        ...
        e.prototype.techGet_ = function(t) {
            if (this.tech_ && this.tech_.isReady_) {
                ...
                try {
                    ...
                    if (void 0 === this.tech_[t]) throw Ye("Video.js: " + t + " method not defined for " + this.techName_ + " playback technology.", e),
                    e;
                    if ("TypeError" === e.name) throw Ye("Video.js: " + t + " unavailable on " + this.techName_ + " playback technology element.", e),
        ...
        e.prototype.requestFullscreen = function() {
            var t = wn;
            this.isFullscreen(!0),
            t.requestFullscreen ? (X(de, t.fullscreenchange, pn(this,
            function e(n) {
                this.isFullscreen(de[t.fullscreenElement]),
                !1 === this.isFullscreen() && q(de, t.fullscreenchange, e),
                this.trigger("fullscreenchange")
        ...
        e.prototype.exitFullscreen = function() {
            var t = wn;
            this.isFullscreen(!1),
            t.requestFullscreen ? de[t.exitFullscreen]() : this.tech_.supportsFullScreen() ? this.techCall_("exitFullScreen") : (this.exitFullWindow(), this.trigger("fullscreenchange"))
        },
    ...
    Co = function() {
        ...
        t.registerPlugin = function(e, n) {
            ...
            return vo[e] = n,
            "plugin" !== e && (t.isBasic(n) ? po.prototype[e] = bo(e, n) : po.prototype[e] = To(e, n)),
            n
        },
    ...
    Eo = function(t) {
        ...
        r = {};
        "object" === (void 0 === e ? "undefined": Re(e)) ? (e.constructor !== Object.prototype.constructor && (n = e.constructor), r = e) : "function" == typeof e && (n = e),
        ko(n, t);
        for (var i in r) r.hasOwnProperty(i) && (n.prototype[i] = r[i]);
        return n
    };
    if ("undefined" == typeof HTMLVideoElement && h() && (de.createElement("video"), de.createElement("audio"), de.createElement("track"), de.createElement("video-js")), re.hooks_ = {},
    re.hooks = function(t, e) {
        return re.hooks_[t] = re.hooks_[t] || [],
    ...
    re.registerComponent = function(t, e) {
        Vr.isTech(e) && Ye.warn("The " + t + " tech was registered as a component. It should instead be registered using videojs.registerTech(name, tech)"),
    ...
    re.plugin = function(t, e) {
        return Ye.warn("videojs.plugin() is deprecated; use videojs.registerPlugin() instead"),
    ...
    re.addLanguage = function(t, e) {
        ...
        re.options.languages = tt(re.options.languages, (n = {},
        n[t] = e, n)),
    ...
    ["isEl", "isTextNode", "createEl", "hasClass", "addClass", "removeClass", "toggleClass", "setAttributes", "getAttributes", "emptyEl", "appendContent", "insertContent"].forEach(function(t) {
        re[t] = function() {
            return Ye.warn("videojs." + t + "() is deprecated; use videojs.dom." + t + "() instead"),
